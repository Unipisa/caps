...
import { NavLink, NavItem, Nav } from 'react-bootstrap'
...
export default function NavBar() {
    ...
    return <Nav className="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <NavItem>
            <NavLink href={`/users/${engine.user._id}`}>
                <svg className="svg-inline--fa fa-file-alt fa-w-12 mr-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
        ...
        <NavItem>
            <NavLink className="nav-link" href="/forms/edit">
        ...
        <NavItem>
            <NavLink className="nav-link caps-proposal-link" href="/proposals">
        ...
        <NavItem>
            <NavLink className="nav-link caps-form-link" href="/forms">
        ...
        <NavItem>
            <NavLink className="nav-link" href="/degrees">
        ...
        <NavItem>
            <NavLink className="nav-link" href="/curricula">
        ...
        <NavItem>
            <NavLink className="nav-link" href="/exams">
        ...
        <NavItem>
            <NavLink className="nav-link" href="/form_templates">
                <svg className="svg-inline--fa fa-table fa-w-16 mr-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M464 32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V80c0-26.51-21.49-48-48-48zM224 416H64v-96h160v96zm0-160H64v-96h160v96zm224 160H288v-96h160v96zm0-160H288v-96h160v96z"></path></svg>
                <span>Modelli</span>
            </NavLink >
        </NavItem>
