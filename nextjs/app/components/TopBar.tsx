...
import {logout} from '../util/engine'
import { useUserProfile, UserProfile } from './Provider'
...
function UserProfile({user}:{
    ...
    return <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        <div className="dropdown-item">
            Collegato come <strong>{ user.username }</strong> 
            { user.admin? " (amministratore)" : "" }
        </div>
        <div className="dropdown-divider" />
        <a className="dropdown-item" href={`/users/${user._id}`}>
